...
class GamerMostGamesAddedList(View):
    def get(self, request):
        ...
        template = 'gamers/list_gamers_most_games_added.html'
        
        # The context will be a dictionary that the template can access to show data
        context = {
            "gamers_most_games_added_list": gamers_most_games_added
        }
